...
$sendToEmail = 'contact@resonate-photography.com';
...
try
{
    ...
    $emailTextHtml .= "<h3>New message from resonate-photography.com:</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>Nate Hough</p>";
